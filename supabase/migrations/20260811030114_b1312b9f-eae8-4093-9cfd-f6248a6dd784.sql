CREATE OR REPLACE FUNCTION public.save_global_whiteboard_scene(
  _board_id text,
  _elements jsonb,
...
BEGIN
  ...
  INSERT INTO public.global_whiteboard (id, scene, updated_by, updated_at)
  VALUES (
    _board_id,
    jsonb_build_object(
      'elements', _elements,
...
REVOKE ALL ON FUNCTION public.save_global_whiteboard_scene(text, jsonb, jsonb, jsonb) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.save_global_whiteboard_scene(text, jsonb, jsonb, jsonb) TO authenticated, service_role;