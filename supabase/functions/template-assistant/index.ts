...
const TEMPLATES: { id: string; desc: string }[] = [
  ...
  { id: "swift", desc: "Swift app and systems development" },
  { id: "crystal", desc: "Crystal compiled programming" },
  { id: "elixir", desc: "Elixir concurrent functional programming" },
  { id: "erlang", desc: "Erlang OTP style development" },
  { id: "julia", desc: "Julia scientific computing" },
  { id: "ocaml", desc: "OCaml functional programming" },
  { id: "pony", desc: "Pony actor concurrency" },
  { id: "scala", desc: "Scala JVM development" },
  { id: "vim", desc: "Vim script automation" },
  { id: "lazyk", desc: "Lazy K esoteric language" },
