...
const designTemplate: FileNode[] = [
  {
    ...
    children: [
      ...
      {
        id: "main-design-component",
        name: "MyComponent.tsx",
        type: "file",
        language: "typescript",
        content: `// Generated by UI Designer — edit in Design view or directly here
...
`,
      },
      {
        ...
        type: "file",
        language: "markdown",
        content: `# UI Designer Project

Open \`main.design.json\` to start building with the visual UI designer.

## How to use
1. Select **UI Designer** template when creating a new project
2. Open \`main.design.json\` to launch the visual editor
3. Drag components from the palette onto the canvas
4. Edit properties in the right panel
5. The generated code appears in \`MyComponent.tsx\`
`,
      },
    ],
  },
