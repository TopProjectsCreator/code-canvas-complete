...
export default function ScratchPage() {
  return (
    <main className="min-h-screen bg-background px-6 py-12 text-foreground">
      <Seo
        title="Scratch-style Block Editor | Code Canvas"
        description="A custom block-based programming editor with sprite stage runtime, native browser bridging, and full .sb3 import/export."
        path="/scratch"
      />
      <div className="mx-auto max-w-4xl space-y-8 rounded-2xl border border-border bg-card/40 p-8">
        <header className="space-y-3">
          ...
          <p className="text-base text-muted-foreground">
            ...
            browser, and export to the standard <code className="rounded-sm bg-muted px-1">.sb3</code> format.
          </p>
        </header>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
            ...
            <li><strong>Native browser bridging.</strong> <code className="rounded-sm bg-muted px-1">ask</code>/<code className="rounded-sm bg-muted px-1">prompt</code> blocks bridge to native browser dialogs.</li>
            ...
            <li><strong>SB3 import/export.</strong> Round-trip with the official <code className="rounded-sm bg-muted px-1">.sb3</code> zip format so projects move in and out of scratch.mit.edu.</li>
