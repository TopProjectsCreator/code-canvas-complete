    ...
    <div style={{ background: "#0f0f10", minHeight: "100vh", fontFamily: "'Inter', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 5, height: 520, maxWidth: 980, margin: "60px auto 0" }}>
        ...
        <div style={{ position: "absolute", left: 180, top: 300, display: "flex", gap: 14 }}>
          <button onClick={() => window.location.href = `${import.meta.env.BASE_URL}editor`} style={{ background: "#ff6b00", border: "none", color: "#000", fontWeight: 700, fontSize: 15, padding: "14px 28px", borderRadius: 10, cursor: "pointer", display: "flex", alignItems: "center", gap: 8, boxShadow: "0 0 24px rgba(255,107,0,0.35)" }}>
